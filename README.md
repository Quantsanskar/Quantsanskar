<div align="center">
  <img src="./1372963.png" alt="Pixel art of a developer setup with cityscape view" width="100%"/>
</div>
...
## 🌐 About Me
> **Full Stack Developer | Blockchain Engineer | AI/ML Enthusiast | Cybersecurity Researcher | Community Leader**  
> Building innovative technology solutions from Delhi, India 🇮🇳

- 🚀 **Currently Building**: DeFi protocols, AI-powered applications, and secure web solutions
- 🔗 **Tech Stack**: Blockchain, Full Stack Development, AI/ML, Cybersecurity
- 👥 **Community Leadership**: Founder of Quakity, Conventus & BuildersSpace communities
- 🏆 **SIH 2024 Finalist** & Multiple hackathon winner
- 🎯 **Mission**: Bridging traditional tech with emerging technologies
- 📚 **Teaching**: Web3, AI/ML, and secure development practices
- 💡 **Open for**: Technical collaborations, speaking opportunities, and advisory roles
...
### 🔗 Blockchain & Web3
- **Smart Contract Development** on Ethereum, Polygon, Solana
...
- **Founded** Quakity, Conventus & BuildersSpace communities
- **Organizing** tech meetups, hackathons, and workshops
- **Mentoring** developers across multiple domains
...
- **Mentored** 50+ developers in their Web2 to Web3 transitioning journey
...
- **Published** research on cross-chain interoperability solutions
- **Created** open-source contributions and mentored at major open source communities

### 🏅 Recognition & Impact
- **Winner** of multiple Web3 & Web2 hackathons
- **Advisor** to early-stage Web3 Web2 startups
- **Top contributor** to Web3 and Web2 open source repositories
...
- **Tech Startups** to advise or join as technical co-founder
- **Speaking Opportunities** at tech conferences and universities
- **Collaboration** on innovative projects (Web3, AI/ML, Cybersecurity)
- **Community Partnerships** for developer education and growth
- **Open Source Contributors** for cutting-edge technology projects
...
<picture>
  <source
    ...
    srcset="https://raw.githubusercontent.com/Quantsanskar/Quantsanskar/output/github-contribution-grid-snake-dark.svg"
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="https://raw.githubusercontent.com/Quantsanskar/Quantsanskar/output/github-contribution-grid-snake.svg"
  />
  <img
    alt="github contribution grid snake animation"
    src="https://raw.githubusercontent.com/Quantsanskar/Quantsanskar/output/github-contribution-grid-snake.svg"
  />
</picture>
